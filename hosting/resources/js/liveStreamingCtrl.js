(function () {
  var app = angular.module('hosting.liveStream', [])
  ...
  app.controller('RemoteStreamsController', ['camera', '$location', '$http', function (camera, $location, $http) {
    ...
    rtc.loadData = function () {
      ...
      $http.get(apiUri + 'streams.json').then(function (data) {        
        // filter own stream
        var streams = data.data.filter(function (stream) {
