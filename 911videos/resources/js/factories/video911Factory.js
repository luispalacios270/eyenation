;( function( video911App, window, undefined ) {
    ...
    video911App.factory( "video911Factory", function( $http, $location ) {
        ...
        function init($http) {
            ...
            $http({ withCredentials: true, method: 'GET', url: 'http://ec2-34-208-118-56.us-west-2.compute.amazonaws.com:3000/api/911videos' }).then(function(resp) {
                triggerRegisteredEvent('video911DataLoaded', resp);
            });

            $http({ withCredentials: true, method: 'GET', url: 'http://ec2-34-208-118-56.us-west-2.compute.amazonaws.com:3000/api/911videos/related' }).then(function(resp) {
