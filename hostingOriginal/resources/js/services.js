  ...
  .factory('servicesAPI', function ($http) {
      ...
      editVideo: function(uniqueName, description, nomvideo, category){
        return $http({
          ...
          data: {'unique_name' : uniqueName, 'description' : description, 'name' : nomvideo, 'category' : category},
          headers: {'Content-Type': 'application/json; charset=utf-8'}
       });
      },
      ...
      createHomeAccountName: function(username,pwd,email,firstname,lastname,telephone,address,city,country,state,language){
        return $http({
          method: 'POST',
          url: '/api/users/',
          data: {'username' : username,'pwd' : pwd,'email': email,'firstname' : firstname,'lastname' : lastname,'telephone' : telephone,'address' : address,'city' : city,'country' : country,'state' : state,'language' : language},
      ...
      createHomeAccountWithoutName: function(pwd,email,firstname,lastname,telephone,address,city,country,state,language){
        return $http({
          method: 'POST',
          url: '/api/users/',
          data: {'pwd' : pwd,'email': email,'firstname' : firstname,'lastname' : lastname,'telephone' : telephone,'address' : address,'city' : city,'country' : country,'state' : state,'language' : language},
          headers: {'Content-type': 'application/json'}
        });
      },
      createFacebookAccount: function(pwd,email,firstname,lastname,telephone,address,city,country,state,language,socialNetwork){
        return $http({
          method: 'POST',
          url: '/api/users/',
          data: {'pwd' : pwd,'email': email,'firstname' : firstname,'lastname' : lastname,'telephone' : telephone,'address' : address,'city' : city,'country' : country,'state' : state,'language' : language,'socialNetwork' : socialNetwork},
          headers: {'Content-type': 'application/json'}
        });
      },
      ...
      editAccount: function(username,newEmail,firstname,lastname,telephone,address,city,country,state,language){
        return $http({
          method: 'POST',
          url: '/api/users/',
          data: {'username' : username,'email': newEmail,'firstname' : firstname,'lastname' : lastname,'telephone' : telephone,'address' : address,'city' : city,'country' : country,'state' : state,'language' : language},
          headers: {'Content-type': 'application/json'}
        });
      },
