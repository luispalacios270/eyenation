angular.module('hosting.account', ['ngRoute', 'hosting.services', 'hosting.prefs'])
  ...
  .config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
      $routeProvider
            .when("/signup", {templateUrl: "resources/views/account/createAccount.html", controller: "createAccountController"})
            .when("/edit", {templateUrl: "resources/views/account/editAccount.html", controller: "editAccountController"})
            .when("/live", {templateUrl: "resources/views/live.html", controller: "RemoteStreamsController"})
            .when("/signup-security", {templateUrl: "resources/views/account/createSecurityPersonAccount.html", controller: "securityPersonCtrl"})
            ;
    ...
    .controller('securityPersonCtrl', function($scope,$rootScope,servicesAPI){
       ...
       servicesAPI.getCountries().success(function(data){
        ...
        $scope.getStates = function(){
           ...
           servicesAPI.getStates(countryCode).success(function(data){
