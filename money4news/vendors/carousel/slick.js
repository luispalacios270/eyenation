...
(function(factory) {
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.options.arrows === true && _.slideCount > _.options.slidesToShow) {
            ...
            _.$prevArrow = $(
                '<button type="button" class="left carousel-control glyphicon glyphicon-chevron-left" tabIndex="-1"></button>').appendTo(
                _.$slider);
            _.$nextArrow = $(
                '<button type="button" class="right carousel-control glyphicon glyphicon-chevron-right" tabIndex="-1"></button>').appendTo(
                _.$slider);
